...
public class Main {
	...
	public static void main(String args[]) throws RepositoryException {
		...
		// Business logic user
		 User user= new User("user","update","sqlAddedUser",null);
		 us.addUser(user);
		...
		//System.out.println(issueRepository.exists(is.getIssueByName("xxxx")));
		//is.updateIssue(is.getIssueByName("Test issue 1"), "xxxx111");
        //is.assignToWorkItem(is.getIssueByName("xxxx"), "42691084-c587-4aad-bdd6-7cd82cb2472d");
